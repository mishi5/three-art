...
export const BloomNode: NodeTypeDef = {
  type: "Bloom",
  category: "effect",
  description: "node.Bloom.desc",
  isSink: true,
  inputs: [{ id: "in", label: "in", type: "texture", description: "node.Bloom.port.in" }],
  outputs: [{ id: "texture", label: "tex", type: "texture", description: "node.Bloom.port.texture" }],
  params: [
    EFFECT_ENABLED_PARAM,
    { id: "threshold", label: "threshold", kind: "number", default: 0.7, min: 0, max: 1, step: 0.01, description: "node.Bloom.param.threshold" },
    { id: "intensity", label: "intensity", kind: "number", default: 1, min: 0, max: 3, step: 0.01, description: "node.Bloom.param.intensity" },
    { id: "radius", label: "radius", kind: "number", default: 4, min: 0.5, max: 20, step: 0.1, description: "node.Bloom.param.radius" },
  ],
