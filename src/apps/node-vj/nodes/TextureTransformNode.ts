...
export const TextureTransformNode: NodeTypeDef = {
  ...
  category: "effect",
  description: "node.TextureTransform.desc",
  isSink: true,
  inputs: [{ id: "in", label: "in", type: "texture", description: "node.TextureTransform.port.in" }],
  outputs: [{ id: "texture", label: "tex", type: "texture", description: "node.TextureTransform.port.texture" }],
  params: [
    EFFECT_ENABLED_PARAM,
    { id: "offsetX", label: "offsetX", kind: "number", default: 0, min: -1, max: 1, step: 0.01, description: "node.TextureTransform.param.offsetX" },
    { id: "offsetY", label: "offsetY", kind: "number", default: 0, min: -1, max: 1, step: 0.01, description: "node.TextureTransform.param.offsetY" },
    { id: "scaleX", label: "scaleX", kind: "number", default: 1, min: 0.1, max: 4, step: 0.01, description: "node.TextureTransform.param.scaleX" },
    { id: "scaleY", label: "scaleY", kind: "number", default: 1, min: 0.1, max: 4, step: 0.01, description: "node.TextureTransform.param.scaleY" },
    { id: "rotation", label: "rotation", kind: "number", default: 0, min: -3.14159, max: 3.14159, step: 0.01, description: "node.TextureTransform.param.rotation" },
    { id: "flipX", label: "flipX", kind: "enum", default: "off", options: ["off", "on"], description: "node.TextureTransform.param.flipX" },
    { id: "flipY", label: "flipY", kind: "enum", default: "off", options: ["off", "on"], description: "node.TextureTransform.param.flipY" },
    { id: "wrap", label: "wrap", kind: "enum", default: "none", options: ["none", "repeat", "mirror", "clamp"], description: "node.TextureTransform.param.wrap" },
  ],
