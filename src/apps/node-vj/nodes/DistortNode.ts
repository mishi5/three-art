...
export const DistortNode: NodeTypeDef = {
  type: "Distort",
  category: "effect",
  description: "node.Distort.desc",
  isSink: true,
  inputs: [{ id: "in", label: "in", type: "texture", description: "node.Distort.port.in" }],
  outputs: [{ id: "texture", label: "tex", type: "texture", description: "node.Distort.port.texture" }],
  params: [
    EFFECT_ENABLED_PARAM,
    { id: "mode", label: "mode", kind: "enum", default: "fisheye", options: ["fisheye", "twist", "wave"], description: "node.Distort.param.mode" },
    { id: "amount", label: "amount", kind: "number", default: 0.5, min: -1, max: 1, step: 0.01, description: "node.Distort.param.amount" },
    { id: "centerX", label: "centerX", kind: "number", default: 0, min: -0.5, max: 0.5, step: 0.01, description: "node.Distort.param.centerX" },
    { id: "centerY", label: "centerY", kind: "number", default: 0, min: -0.5, max: 0.5, step: 0.01, description: "node.Distort.param.centerY" },
    { id: "radius", label: "radius", kind: "number", default: 0.5, min: 0.05, max: 1.5, step: 0.01, description: "node.Distort.param.radius" },
    { id: "mix", label: "mix", kind: "number", default: 1, min: 0, max: 1, step: 0.01, description: "node.Distort.param.mix" },
  ],
