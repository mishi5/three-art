...
export const PixelateNode: NodeTypeDef = {
  type: "Pixelate",
  category: "effect",
  description: "node.Pixelate.desc",
  isSink: true,
  inputs: [{ id: "in", label: "in", type: "texture", description: "node.Pixelate.port.in" }],
  outputs: [{ id: "texture", label: "tex", type: "texture", description: "node.Pixelate.port.texture" }],
  params: [
    EFFECT_ENABLED_PARAM,
    { id: "blockSize", label: "blockSize", kind: "number", default: 16, min: 1, max: 128, step: 1, description: "node.Pixelate.param.blockSize" },
    { id: "posterize", label: "posterize", kind: "int", default: 0, min: 0, max: 16, step: 1, description: "node.Pixelate.param.posterize" },
  ],
