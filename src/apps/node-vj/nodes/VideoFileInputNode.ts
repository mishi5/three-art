...
export const VideoFileInputNode: NodeTypeDef = {
  ...
  inputs: [],
  outputs: [
    { id: "texture", label: "tex", type: "texture", description: "node.VideoFileInput.port.texture" },
    ...AUDIO_FEATURE_OUTPUTS,
    SIGNAL_OUTPUT,
  ],
  params: [
    { id: "loop", label: "loop", kind: "enum", default: "on", options: ["on", "off"], description: "node.VideoFileInput.param.loop" },
    FADE_PARAM,
    { id: "extractAudio", label: "extractAudio", kind: "enum", default: "off", options: ["off", "on"], description: "node.VideoFileInput.param.extractAudio" },
    ...ONSET_PARAMS,
    { id: "assetId", label: "asset", kind: "string", default: "", noInput: true, hidden: true,
      description: "node.VideoFileInput.param.assetId" },
  ],
