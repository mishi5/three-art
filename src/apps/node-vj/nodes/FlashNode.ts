...
export const FlashNode: NodeTypeDef = {
  type: "Flash",
  category: "effect",
  description: "node.Flash.desc",
  isSink: true,
  inputs: [
    { id: "trigger", label: "trig", type: "trigger", description: "node.Flash.port.trigger" },
    { id: "in", label: "in", type: "texture", description: "node.Flash.port.in" },
  ],
  outputs: [{ id: "texture", label: "tex", type: "texture", description: "node.Flash.port.texture" }],
  params: [
    EFFECT_ENABLED_PARAM,
    { id: "release", label: "release", kind: "number", default: 0.15, min: 0.01, max: 3, step: 0.01, description: "node.Flash.param.release" },
    { id: "hue", label: "hue", kind: "number", default: 0, min: 0, max: 1, step: 0.01, description: "node.Flash.param.hue" },
    { id: "saturation", label: "saturation", kind: "number", default: 0, min: 0, max: 1, step: 0.01, description: "node.Flash.param.saturation" },
  ],
