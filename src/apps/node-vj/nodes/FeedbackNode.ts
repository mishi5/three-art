...
export const FeedbackNode: NodeTypeDef = {
  type: "Feedback",
  category: "effect",
  description: "node.Feedback.desc",
  isSink: true,
  inputs: [{ id: "in", label: "in", type: "texture", description: "node.Feedback.port.in" }],
  outputs: [{ id: "texture", label: "tex", type: "texture", description: "node.Feedback.port.texture" }],
  params: [
    EFFECT_ENABLED_PARAM,
    { id: "decay", label: "decay", kind: "number", default: 0.9, min: 0, max: 1, step: 0.01, description: "node.Feedback.param.decay" },
    { id: "offsetX", label: "offsetX", kind: "number", default: 0, min: -0.2, max: 0.2, step: 0.005, description: "node.Feedback.param.offsetX" },
    { id: "offsetY", label: "offsetY", kind: "number", default: 0, min: -0.2, max: 0.2, step: 0.005, description: "node.Feedback.param.offsetY" },
    { id: "scale", label: "scale", kind: "number", default: 1, min: 0.9, max: 1.1, step: 0.001, description: "node.Feedback.param.scale" },
    { id: "rotate", label: "rotate", kind: "number", default: 0, min: -30, max: 30, step: 0.1, description: "node.Feedback.param.rotate" },
  ],
