...
export const AudioFileInputNode: NodeTypeDef = {
  ...
  outputs: [
    ...
    { id: "section", label: "section", type: "number", description: "node.AudioFileInput.port.section" },
    SIGNAL_OUTPUT,
  ],
  params: [
    { id: "loop", label: "loop", kind: "enum", default: "on", options: ["on", "off"], description: "node.AudioFileInput.param.loop" },
    ...ONSET_PARAMS,
    { id: "assetId", label: "asset", kind: "string", default: "", noInput: true, hidden: true,
      description: "node.AudioFileInput.param.assetId" },
  ],
