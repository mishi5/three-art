...
export const KaleidoscopeNode: NodeTypeDef = {
  type: "Kaleidoscope",
  category: "effect",
  description: "node.Kaleidoscope.desc",
  isSink: true,
  inputs: [{ id: "in", label: "in", type: "texture", description: "node.Kaleidoscope.port.in" }],
  outputs: [{ id: "texture", label: "tex", type: "texture", description: "node.Kaleidoscope.port.texture" }],
  params: [
    EFFECT_ENABLED_PARAM,
    { id: "segments", label: "segments", kind: "int", default: 6, min: 2, max: 16, step: 1, description: "node.Kaleidoscope.param.segments" },
    { id: "rotation", label: "rotation", kind: "number", default: 0, min: -3.14, max: 3.14, step: 0.01, description: "node.Kaleidoscope.param.rotation" },
    { id: "centerX", label: "centerX", kind: "number", default: 0, min: -0.5, max: 0.5, step: 0.01, description: "node.Kaleidoscope.param.centerX" },
    { id: "centerY", label: "centerY", kind: "number", default: 0, min: -0.5, max: 0.5, step: 0.01, description: "node.Kaleidoscope.param.centerY" },
    { id: "mix", label: "mix", kind: "number", default: 1, min: 0, max: 1, step: 0.01, description: "node.Kaleidoscope.param.mix" },
  ],
