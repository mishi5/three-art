...
export const PoseFeaturesNode: NodeTypeDef = {
  ...
  outputs: [
    { id: "handHeightL", label: "handL", type: "number", description: "node.PoseFeatures.port.handHeightL" },
    { id: "handHeightR", label: "handR", type: "number", description: "node.PoseFeatures.port.handHeightR" },
    { id: "motion", label: "motion", type: "number", description: "node.PoseFeatures.port.motion" },
  ],
  params: [
    { id: "smoothing", label: "smoothing", kind: "number", default: 0.3, min: 0.01, max: 1, step: 0.01, description: "node.PoseFeatures.param.smoothing" },
    { id: "raiseSpan", label: "raiseSpan", kind: "number", default: 1.2, min: 0.1, max: 3, step: 0.05, description: "node.PoseFeatures.param.raiseSpan" },
    { id: "motionScale", label: "motionScale", kind: "number", default: 0.3, min: 0.01, max: 1, step: 0.01, description: "node.PoseFeatures.param.motionScale" },
    { id: "outMin", label: "outMin", kind: "number", default: 0, step: 0.1, description: "node.PoseFeatures.param.outMin" },
    { id: "outMax", label: "outMax", kind: "number", default: 1, step: 0.1, description: "node.PoseFeatures.param.outMax" },
  ],
