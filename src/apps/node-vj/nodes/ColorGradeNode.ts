...
export const ColorGradeNode: NodeTypeDef = {
  type: "ColorGrade",
  category: "effect",
  description: "node.ColorGrade.desc",
  isSink: true,
  inputs: [{ id: "in", label: "in", type: "texture", description: "node.ColorGrade.port.in" }],
  outputs: [{ id: "texture", label: "tex", type: "texture", description: "node.ColorGrade.port.texture" }],
  params: [
    EFFECT_ENABLED_PARAM,
    { id: "hueShift", label: "hueShift", kind: "number", default: 0, min: 0, max: 1, step: 0.01, description: "node.ColorGrade.param.hueShift" },
    { id: "saturation", label: "saturation", kind: "number", default: 1, min: 0, max: 2, step: 0.01, description: "node.ColorGrade.param.saturation" },
    { id: "brightness", label: "brightness", kind: "number", default: 1, min: 0, max: 2, step: 0.01, description: "node.ColorGrade.param.brightness" },
    { id: "contrast", label: "contrast", kind: "number", default: 1, min: 0, max: 2, step: 0.01, description: "node.ColorGrade.param.contrast" },
  ],
