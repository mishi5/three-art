...
export const FractalNode: NodeTypeDef = {
  type: "Fractal",
  category: "effect",
  description: "node.Fractal.desc",
  isSink: true,
  inputs: [{ id: "in", label: "in", type: "texture", description: "node.Fractal.port.in" }],
  outputs: [{ id: "texture", label: "tex", type: "texture", description: "node.Fractal.port.texture" }],
  params: [
    EFFECT_ENABLED_PARAM,
    { id: "iterations", label: "iterations", kind: "int", default: 3, min: 1, max: 6, step: 1, description: "node.Fractal.param.iterations" },
    { id: "scale", label: "scale", kind: "number", default: 0.7, min: 0.5, max: 0.95, step: 0.01, description: "node.Fractal.param.scale" },
    { id: "rotation", label: "rotation", kind: "number", default: 0, min: -3.14, max: 3.14, step: 0.01, description: "node.Fractal.param.rotation" },
    { id: "fade", label: "fade", kind: "number", default: 0.3, min: 0, max: 1, step: 0.01, description: "node.Fractal.param.fade" },
    { id: "centerX", label: "centerX", kind: "number", default: 0, min: -0.5, max: 0.5, step: 0.01, description: "node.Fractal.param.centerX" },
    { id: "centerY", label: "centerY", kind: "number", default: 0, min: -0.5, max: 0.5, step: 0.01, description: "node.Fractal.param.centerY" },
    { id: "mix", label: "mix", kind: "number", default: 1, min: 0, max: 1, step: 0.01, description: "node.Fractal.param.mix" },
  ],
