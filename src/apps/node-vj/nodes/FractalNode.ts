...
export const FractalNode: NodeTypeDef = {
  ...
  params: [
    { id: "iterations", label: "iterations", kind: "int", default: 3, min: 1, max: 6, step: 1 },
    { id: "scale", label: "scale", kind: "number", default: 0.7, min: 0.5, max: 0.95, step: 0.01 },
    { id: "rotation", label: "rotation", kind: "number", default: 0, min: -3.14, max: 3.14, step: 0.01 },
    { id: "fade", label: "fade", kind: "number", default: 0.3, min: 0, max: 1, step: 0.01 },
