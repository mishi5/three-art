...
export const BlendNode: NodeTypeDef = {
  ...
  isSink: true,
  inputs: [
    { id: "a", label: "a", type: "texture", description: "node.Blend.port.a" },
    { id: "b", label: "b", type: "texture", description: "node.Blend.port.b" },
  ],
  outputs: [{ id: "texture", label: "tex", type: "texture", description: "node.Blend.port.texture" }],
  params: [
    { id: "mode", label: "mode", kind: "enum", default: "add", options: [...BLEND_MODES], description: "node.Blend.param.mode" },
    { id: "mix", label: "mix", kind: "number", default: 1, min: 0, max: 1, step: 0.01, description: "node.Blend.param.mix" },
  ],
